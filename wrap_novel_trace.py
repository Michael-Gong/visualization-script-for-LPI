...
grid_data[grid_data >  2]= 2
plt.contourf(X, Y-12, grid_data.T, levels=levels, norm=mcolors.Normalize(vmin=levels.min(), vmax=levels.max()), cmap=cm.jet)
...
fig.savefig('./figure_wrap_up/'+'move_window.png',format='png',dpi=160)
plt.close("all")
