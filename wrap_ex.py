...
##end for norm colorbar####
 ...
 #   ex[ex < -8]=-8 
    ...
    cbar.set_label('E$_x$ [m$_e$c$\omega_0$/e]',fontdict=font2)    
    ...
    #plt.xticks([])
    ax.text(115,17.5,'t = '+str(round(time/1.0e-15,0))+' fs',fontdict=font)
    ax.set_xlim(85,125)
 ...
 #   ex[ex < -8]=-8 
    ...
    ax.text(115,17.5,'t = '+'400.0 fs',fontdict=font)
    ...
    fig.savefig('./figure_wrap_up/Ex_1.png',format='png',dpi=160)
    plt.close("all")
