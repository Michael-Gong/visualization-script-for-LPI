...
en_Z3 = data3['dist_fn/en/'+name].data[:,0,0]
dist_x3  = data3['Grid/en/'+name].data[0]/(q0*1.0e6)
en_Z4 = data4['dist_fn/en/'+name].data[:,0,0]
dist_x4  = data4['Grid/en/'+name].data[0]/(q0*1.0e6)

plt.plot(dist_x4, en_Z4, label=r"$n_e=2.0n_c$", linewidth=2)
plt.plot(dist_x3, en_Z3, label=r"$n_e=1.0n_c$", linewidth=2)
plt.plot(dist_x2, en_Z2, label=r"$n_e=0.5n_c$", linewidth=2)
plt.plot(dist_x1, en_Z1, label=r"$n_e=0.2n_c$", linewidth=2)
plt.legend(loc='upper right',framealpha=1.0,markerscale=4.0,fontsize=20.0)
#### manifesting colorbar, changing label and axis properties ####
plt.xlim(0.0,160)
plt.ylim(pow(10,10),pow(10,19))
plt.text(10,pow(10,18),r'(a) Electron',fontsize=20,color='k')
...
plt.xlim(0.0,160)
plt.ylim(pow(10,10),pow(10,19))
plt.text(10,pow(10,18),r'(b) Carbon',fontsize=20,color='k')
...
#### manifesting colorbar, changing label and axis properties ####
plt.xlim(0.0,3.2)
plt.ylim(pow(10,10),pow(10,14.5))
plt.text(0.2,pow(10,14),r'(c) Photon',fontsize=20,color='k')
