...
y_y = 1-y_x
width=10
pl=plt.bar(value_axisx, y_x*100, width, color='orangered',edgecolor='black',linewidth=2)
pt=plt.bar(value_axisx, y_y*100, width, bottom=y_x*100, color='dodgerblue',edgecolor='black',linewidth=2)

plt.xlim(-10,710)
plt.ylim(0,101)
plt.xlabel('$\epsilon_e$ [m$_e$c$^2$]',fontdict=font)
plt.ylabel('Work$_{x(y)}$/$\epsilon_e$ [%]',fontdict=font)
