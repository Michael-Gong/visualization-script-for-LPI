...
#    plt.scatter(x1,y1,s=8,c=(0,192.0/255.0,0),label='LL RR',edgecolors='None') 
    plt.scatter(x0,y0,s=20,c=abs(pos0[id0-1]),cmap=cm.rainbow,label='No RR',edgecolors='None') 
...
#    plt.scatter(x2,y2,s=8,c=(192.0/255.0,0,0),label='QED RR',edgecolors='None') 
#    plt.scatter(x1,y1,s=8,c=(0,192.0/255.0,0),label='LL RR',edgecolors='None') 
    plt.scatter(x0,y0,s=20,c=abs(pos1[id0-1]),cmap=cm.rainbow,label='LL RR',edgecolors='None') 
    plt.legend(loc='upper right',framealpha=1.0,markerscale=2,fontsize=20.0)
    plt.xlim(x_min,x_max)
    plt.ylim(y_min,y_max)
...
#    plt.scatter(x2,y2,s=8,c=(192.0/255.0,0,0),label='QED RR',edgecolors='None') 
#    plt.scatter(x1,y1,s=8,c=(0,192.0/255.0,0),label='LL RR',edgecolors='None') 
    plt.scatter(x0,y0,s=20,c=abs(pos2[id0-1]),cmap=cm.rainbow,label='QED RR',edgecolors='None') 
    plt.legend(loc='upper right',framealpha=1.0,markerscale=2,fontsize=20.0)
    ...
    fig.savefig('./gif'+str(n).zfill(4)+'.png',format='png',dpi=45)
    plt.close("all")
    fig.show()
